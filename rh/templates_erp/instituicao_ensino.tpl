	...
	<table width="100%" border="0">        
        ...
        <tr>
		  ...
		  <table border="0" width="100%">
				<tr>
					<td width="21%"><label for="instituicao_ensino" class="labels"><smarty>$campo[2]</smarty></label><br />
						<input name="instituicao_ensino" type="text" class="caixa" id="instituicao_ensino" size="50" placeholder="Instituição" />
						<input name="id_instituicao_ensino" type="hidden" id="id_instituicao_ensino" value="" />						</td>
					</tr>
			</table>
  			<table border="0" width="100%">			  
			  <tr>
