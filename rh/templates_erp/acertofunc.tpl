	...
	<table width="100%" border="0">        
        <tr>
		  ...
		  <table width="100%" border="0">
				...
				<tr>
				  <td valign="middle">
				    <input name="btn_historico" type="button" class="class_botao" id="btn_historico" onclick="openpage('historico','acertofunc_historico.php?codfuncionario='+xajax.$('codfuncionario').value+'',1000,650);" value="Hist�rico" disabled="disabled" />
				  </td>
			  </tr>
				<tr>
