...
<img src='{$PROJETO}/images/logo_pb.png' width="120px" />
...
<div class="auto_lista">
	<div>
		...
		{foreach $grupos as $k => $grupo}
			...
			<tr>
				<th width="50%" colspan="2" style="text-align: center;">Item de avaliação</th>
				<th width="2%" style="text-align: center;">AA</th>
				<th width="2%" style="text-align: center;">ACI</th>
				<th width="2%" style="text-align: center;">Consenso</th>
			</tr>
			{foreach $questoes[$k] as $q => $questao}
				<tr>
