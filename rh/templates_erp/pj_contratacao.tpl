	...
	<table width="100%" border="0">                
        <tr>
		  ...
		  <table border="0" width="100%">
				<tr>
					<td width="21%"><label for="tipo_contratacao" class="labels"><smarty>$campo[2]</smarty></label><br />
						<input name="tipo_contratacao" type="text" class="caixa" id="tipo_contratacao" size="50" placeholder="Tipo" />
				  		<input name="id_tipo_contratacao" type="hidden" id="id_tipo_contratacao" value="" />						</td>
					</tr>
			</table>
  			<table border="0" width="100%">			  
			  <tr>
