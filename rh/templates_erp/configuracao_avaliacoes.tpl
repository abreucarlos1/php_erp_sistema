		...
		<div align="left" id="a_tabbar" mode="top" class="dhtmlxTabBar" imgpath="../includes/dhtmlx_403/dhtmlxTabbar/codebase/imgs/" margin="3" style="height: 550px; width: 100%; margin-top: 20px; margin-right: 3px;" tabstyle="modern" skinColors="#F1F4F5,#F1F4F5">
			...
			<div id="configuracoes" width="100px" name="configuracoes" style="margin-left: 3px;">
				<div id="div_configuracoes" style="width: 100%;">
					<table>
						<tr>
							<td colspan="2"><label for="data_inicio_treinamento_lideranca" class="labels">Início&nbsp;do&nbsp;Treinamento&nbsp;Liderança</label><br />
						...
						<tr>
							<td colspan="2"><label for="data_inicio_treinamento_funcionarios" class="labels">Início&nbsp;do&nbsp;Treinamento&nbsp;Colaboradores</label><br />
						...
						<tr>
							<td width="17%"><label for="data_inicio" class="labels">Início&nbsp;da&nbsp;Auto&nbsp;Avaliação</label><br />
						...
						<tr>
							<td><label for="data_inicio_coord" class="labels">Início&nbsp;Supervisão</label><br />
						...
						<tr>
							...
							<td><label for="data_inicio_consenso" class="labels">Início&nbsp;Consenso</label><br />
