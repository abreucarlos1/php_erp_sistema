	...
	<table width="100%" border="0">        
        ...
        <tr>
		  ...
		  <table border="0" width="100%">
				<tr>
					<td width="21%"><label for="sgi_item" class="labels"><smarty>$campo[2]</smarty></label><br />
						<input name="sgi_item" type="text" class="caixa" id="sgi_item" size="50" placeholder="Item" />
						<input name="id_sgi_item" type="hidden" id="id_sgi_item" value="" />						</td>
					</tr>
			</table>
  			<table border="0" width="100%">			  
			  <tr>
