...
/*
	  ...
	  ../rh/avaliacao_comportamental.php
	
		Versão 0 --> VERSÃO INICIAL : 20/05/2015
		Versão 1 --> atualizacao layout - Carlos Abreu - 04/04/2017	
...
function enviarAvaliacao($dados_form)
{
	...
	return $model->enviarAvaliacao($dados_form, './avaliacao_comportamental.php');
}
...
$retorno = $model->getColaboradores(1);

if ($retorno['avaliacoesAbertas'])
{
	$smarty->assign("body_onload","xajax_getAvaliados();xajax_montarCriterios(1);xajax_montarApresentacao(".$retorno['avaliacoesAbertas'][0].");");
}
else
{
...
$smarty->assign("campo",$conf->campos('avaliacao_comportamental'));
...
$smarty->display('avaliacao_comportamental.tpl');
?>