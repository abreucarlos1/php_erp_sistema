          ...
          <table width="100%" border="0">
            <tr>
              <td width="44%"><label for="funcionario" class="labels">Funcionário&nbsp;/&nbsp;Período </label><br />
              	<input name="funcionario" type="text" class="caixa" readonly="1" value="<smarty>$cont_funcionario['funcionario']</smarty>" size="60">
              </td>
              <td width="56%"><label for="periodo" class="labels">Período</label><br />
              	<input name="periodo" type="text" readonly="1" class="caixa" id="periodo" size="25" value="<smarty>mysql_php($cont_funcionario['data_ini'])</smarty> á <smarty>mysql_php($cont_funcionario['data_fin'])</smarty>">
              </td>
            </tr>
          </table>
          <table width="100%" border="0">
            <tr>
              <td width="20%"><label for="empresa" class="labels">Empresa</label><br />
              	<input name="empresa" type="text" class="caixa" id="empresa" value="<smarty>$cont_funcionario['empresa_func']</smarty>" size="60" readonly="1">
              </td>
            </tr>
          </table>
          <table width="100%" border="0">
