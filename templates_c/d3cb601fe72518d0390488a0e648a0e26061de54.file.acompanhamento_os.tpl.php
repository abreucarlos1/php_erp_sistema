<?php /* Smarty version Smarty-3.1.11, created on 2021-01-06 15:30:17
         compiled from "templates_erp\acompanhamento_os.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9867732815ff5c97910b356-26744198%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd3cb601fe72518d0390488a0e648a0e26061de54' => 
    array (
      0 => 'templates_erp\\acompanhamento_os.tpl',
      1 => 1607358354,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9867732815ff5c97910b356-26744198',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    'option_coorddvm_values' => 0,
    'option_coorddvm_output' => 0,
    'option_status_values' => 0,
    'option_status_output' => 0,
    'option_disciplina_values' => 0,
    'option_disciplina_output' => 0,
    'nome_validacao' => 0,
    'data_validacao' => 0,
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_5ff5c979144121_36194838',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ff5c979144121_36194838')) {function content_5ff5c979144121_36194838($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'C:\\Developer\\XAMPP\\htdocs\\erp_sistema\\includes\\smarty\\libs\\plugins\\function.html_options.php';
						...
						<tr>
                          <td width="15%"><label for="os_coord" class="labels">Projeto coordenador</label><br />
                            <select name="os_coord" class="caixa" id="os_coord" onkeypress="return keySort(this);">
                              <?php echo smarty_function_html_options(array('values'=>$_smarty_tpl->tpl_vars['option_coorddvm_values']->value,'output'=>$_smarty_tpl->tpl_vars['option_coorddvm_output']->value),$_smarty_tpl);?>
                      ...
                      <table width="99%" style="border:solid #999999 1px;" border="1" cellspacing="0" cellpadding="1">                     
                          ...
                          <tr>
                            ...
                            <td width="28%"><label for="data_solicitacao" class="labels">Solicitado em:</label><br />
                            	<input name="data_solicitacao" type="text" class="caixa" id="data_solicitacao" size="10" maxlength="10" disabled="disabled" value="<?php echo smarty_modifier_date_format(time(),'%d/%m/%Y');?>
" onkeypress="transformaData(this, event);" /></td>                       	  
                          </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" valign="top"><label for="disciplina_analise_critica" class="labels">Disciplina</label><br />
                                          <select name="disciplina_analise_critica" class="caixa" style="width:100%"  id="disciplina_analise_critica" onkeypress="return keySort(this);">
                                            <?php echo smarty_function_html_options(array('values'=>$_smarty_tpl->tpl_vars['option_disciplina_values']->value,'output'=>$_smarty_tpl->tpl_vars['option_disciplina_output']->value),$_smarty_tpl);?>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="5">
                       <tr>
                       		<td width="300"><label for="nome_analise" class="labels">Nome:</label><br />
                            	<input type="text" name="nome_analise" id="nome_analise" value="<?php echo $_smarty_tpl->tpl_vars['nome_validacao']->value;?>
" class="caixa" size="50">
                       		<td width="624"><label for="data_analise" class="labels">Data:</label><br />
                            	<input type="text" name="data_analise" id="data_analise" class="caixa" value="<?php echo $_smarty_tpl->tpl_vars['data_validacao']->value;?>
" size="12" maxlength="10" onKeyPress="transformaData(this, event);"></td>
                      </tr>
		 			 	<tr>
							<td colspan="2">							
