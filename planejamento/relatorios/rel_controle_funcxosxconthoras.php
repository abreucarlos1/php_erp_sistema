...
$pdf->Cell(70,5,'FUNCIONÁRIO',0,0);
$pdf->Cell(50,5,'DISCIPLINA',0,0);
$pdf->Cell(25,5,'CATEGORIA',0,1);

$sql = "SELECT * FROM ".DATABASE.".apontamento_horas, ".DATABASE.".rh_funcoes, ".DATABASE.".ordem_servico, ".DATABASE.".setores, ".DATABASE.".ordem_servico_status, ".DATABASE.".funcionarios ";
$sql .= "WHERE ordem_servico.id_cod_coord = '" . $_POST["escolhaos"] . "' ";
...
$sql .= "ORDER BY ordem_servico.os, rh_funcoes.ordem, funcionario ";
