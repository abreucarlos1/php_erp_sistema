<?php
/*
		Formul�rio de OS por disciplina por atividade
...
$campo[1] = "MEDIÇÃO OS POR DISCIPLINA POR STATUS";
...
$smarty->display('os_disciplina_atividade.tpl');	
