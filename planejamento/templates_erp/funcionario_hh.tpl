...
<form name="frm_rel" id="frm_rel" action="relatorios/rel_resumo_hh_funcionarios.php" method="POST" style="margin:0px; padding:0px;">
	<table width="100%" border="0">        
        ...
        <tr>
		  ...
		  <table width="100%" border="0">
				...
				<tr>
					<td colspan="2"><label for="escolhafuncionario" class="labels">FUNCIONÁRIO</label><br />
