...
<form name="frm_rel" id="frm_rel" action="relatorios/rel_diario_obra.php" method="POST" style="margin:0px; padding:0px;">
		  ...
		  <table width="100%" border="0">
				...
				<tr>
					<td width="28%">
						<table width="100%" border="0">
							...
							<tr>
								<td><label class="labels">Data final</label><br />
				...
				<tr>
					<td colspan="2"><label for="exibir" class="labels">STATUS</label><br />
 						<select name="exibir" class="caixa" id="exibir" onChange="xajax_preencheos(this.value);" onkeypress="return keySort(this);">
