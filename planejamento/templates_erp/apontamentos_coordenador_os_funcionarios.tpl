...
<form name="frm_rel" id="frm_rel" action="relatorios/rel_apontamentos_coord_os_func.php" method="POST" style="margin:0px; padding:0px;">
	<table width="100%" border="0">        
        ...
        <tr>
		  ...
		  <table width="100%" border="0">
					...
					<td width="42%">
						<table width="100%" border="0">
							...
							<tr>
                                ...
                                <input name="datafim" type="text" class="caixa" id="datafim" size="10" placeholder="Data fin." onkeypress="transformaData(this, event);" onkeyup="return autoTab(this,'coordenador', 10);"  />                               
                                </td>
							</tr>
						</table>
						</td>
				...
				<tr>
					<td colspan="2"><label for="coordenador" class="labels">COORDENADOR</label><br />
						<select name="coordenador" class="caixa" id="coordenador" onkeypress="return keySort(this);">
