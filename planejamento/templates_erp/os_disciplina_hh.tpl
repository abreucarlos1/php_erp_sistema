...
<form name="frm_rel" id="frm_rel" action="relatorios/rel_resumo_hh_os.php" method="POST" style="margin:0px; padding:0px;">
	<table width="100%" border="0">        
        ...
        <tr>
		  ...
		  <table width="100%" border="0">
					...
					<td width="28%">
						<table width="100%" border="0">
							...
							<tr>
                                ...
                                <input name="datafim" type="text" class="caixa" id="datafim" size="10" placeholder="Data ini." onkeypress="transformaData(this, event);" onkeyup="return autoTab(this,'status', 10);"  />
                                </td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td colspan="2"><label for="status" class="labels">STATUS</label><br />
