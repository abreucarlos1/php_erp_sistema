...
{	
	...
	$sql = "SELECT SUM(AF9_CUSTO) AS CUSTO_TOTAL FROM AF9010 ";
	...
	$sql = "SELECT SUM(AFU_CUSTO1) AS CUSTO_TOTAL FROM AFU010 ";
	...
	for($i=0;$i<=count($semanas);$i++)
	{
		...
		$sql = "SELECT SUM(AF9_CUSTO) AS CustoPrev FROM AF8010, AF9010 ";
		...
		$sql = "SELECT SUM(AFU_CUSTO1) AS CustoReal FROM AF8010, AFU010 ";
