<?php
/*
		Relat�rio S�cios x empresas x OS 
	...
	if($num_regs>0)
	{
		...
		foreach($totsal as $os => $valor)
		{
			...
			if($os<100)
			{
				...
				{
					$data .= $reg_empresas["funcionario"] . ";" . number_format($reg_empresas["salario_clt"],2,",",".") . ";". $site[$os] . ";". $cliente[$os].";0". $os . ";" . "-" . ";" . number_format($valor,2,",",".") . "\n";
					$celb[$i] = "B".$celulas;
				}
				else
				{
...
//echo $corpo;
$cabecalho = "Funcion�rio (S�CIOS);Sal�rio;Site;Cliente;C.C.;OS;valor (R$)"; 
