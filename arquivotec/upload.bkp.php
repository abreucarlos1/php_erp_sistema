		...
		foreach($_POST as $campo=>$id_ged_versao)
		{
			...
			if($campo_versoes[0]=='idgedversao')
			{
				...
				{					
					...
					$sql = "SELECT *, ged_arquivos.descricao AS num_arquivo FROM ".DATABASE.".numeros_interno, ".DATABASE.".setores, ".DATABASE.".ged_arquivos, ".DATABASE.".solicitacao_documentos_detalhes, ".DATABASE.".ged_versoes, ".DATABASE.".OS ";
...
if($_POST["funcao"]=='comentario')
{
	...
	{
		$sql = "SELECT * FROM ".DATABASE.".numeros_interno, ".DATABASE.".setores, ".DATABASE.".ged_arquivos, ".DATABASE.".solicitacao_documentos_detalhes, ".DATABASE.".ged_versoes, ".DATABASE.".OS ";
		$sql .= "WHERE numeros_interno.reg_del = 0 ";
		$sql .= "AND solicitacao_documentos_detalhes.reg_del = 0 ";
		$sql .= "AND ged_arquivos.reg_del = 0 ";
		$sql .= "AND ged_versoes.reg_del = 0 ";
								...
								{																
									...
									{										
										...
										if($arquivo)
										{
											...
											$abreviacao_cliente = str_replace($array_rpl, " ",maiusculas(tiraacentos($reg_docsref["abreviacao_GED"])));		
											
											$descricao_os = str_replace($array_rpl," ",maiusculas(tiraacentos($reg_docsref["descricao"])));
			...
			{		
				...
				case "0": //novos arquivos (upload)
					...
					{					
						...
						WHERE numeros_interno.id_os = OS.id_os 
						...
						{	
							...
							$descricao_os = str_replace($array_rpl," ",maiusculas(tiraacentos($reg_numdvm["OS_Descricao"])));
