	        ...
	        <tr>
	          <td colspan="2" valign="top" class="td_sp">
	            ...
	            <tr>
	              ...
	              <td class="td_sp"><input name="chk_periodo" type="checkbox" id="chk_periodo" value="1" onClick="if(this.checked){xajax.$('chk_emitidos').checked=true;xajax.$('div_periodo').style.display='inline';xajax.$('dataini').focus();}else{xajax.$('dataini').value='';xajax.$('datafim').value='';xajax.$('div_periodo').style.display='none';}"><span class="labels">Per�odo (Data de Emiss�o)</span></td>
	              ...
	              <span class="labels">Per&iacute;odo (Data de Devolução)</span></td>
	            </tr>
	            <tr class="borda_esquerda">
	              ...
	              <input type="text" name="dataini" id="dataini" class="caixa" size="12" onKeyPress="transformaData(this, event);" onKeyUp="return autoTab(this,'datafim', 10);" /> <span class="labels">at�</span> 
	              ...
	              <input type="text" name="dataini_dev" id="dataini_dev" class="caixa" size="12" onKeyPress="transformaData(this, event);" onKeyUp="return autoTab(this,'datafim_dev', 10);" /> <span class="labels">at�</span> 
