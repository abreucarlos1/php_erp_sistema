        ...
        <tr>
		  ...
		  <table width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
                  ...
                  <input type="text" name="txt_busca" class="caixa" id="txt_busca" placeholder="Busca" onKeyPress="if(event.keyCode=='13'){xajax_atualizatabela(this.value,'busca');}" size="17" title="Critérios: Nº Pacote, Nº OS, Nome do arquivo, Nº INT, Nº Cliente, Solicitante ou Data"></td>
			  </tr>
		  </table></td>
          <td colspan="2" valign="top" class="espacamento">
            <table width="100%" border="0">
              ...
              <tr>
                <td><label class="labels">Coordenador INT:</label></td>
