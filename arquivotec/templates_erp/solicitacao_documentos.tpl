       			...
       			<div id="my_tabbar" style="height:600px;">                                     
                    ...
                    <div id="a20">     
                        ...
                        <table width="100%" border="0">
                            <tr>
                                ...
                                <select name="finalidade" class="caixa" id="finalidade" disabled="disabled" onkeypress="return keySort(this);">
                                        ...
                                        <option value="REVIS�O">REVIS&Atilde;O</option>
                                                            </select></td>
                                <td width="74%"><label for="servico" class="labels">Servi�o</label><br /> 
                      ...
                      <tr>
                        ...
                        <table width="100%" border="0">
                            <tr>
                                <td width="7%"><label for="area" class="labels">&Aacute;rea</label><br />
                                ...
                                <td width="49%"><label for="txt_obs" class="labels">Observações:</label><br />
                                  <input name="txt_obs" type="text" class="caixa" id="txt_obs" size="30" placeholder="Observa��o" maxlength="60">
                               </td>
                            </tr>
                        </table>
                      </div>
