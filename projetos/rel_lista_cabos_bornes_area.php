...
$sql .= "WHERE area.id_area = '" .$_POST["id_area"]. "' ";
$sql .= "AND area.id_area = subsistema.id_area ";
$regis = mysql_query($sql,$conexao) or die("Não foi possível a seleção dos dados" . $sql);
while($subsis = mysql_fetch_array($regis))
{
*/
	...
	/*
	$pdf->SetFont('Arial','B',8);
	$pdf->Cell(285,10, $subsis["subsistema"] ,0,1,'L',0);
	$pdf->SetFont('Arial','',8);
	*/
	...
	//$sql .= "cabos.identificacao_cabo, cabos_tipos.ds_formacao, cabos.nr_comprimento, cabos.ds_trecho, cabos.ds_observacao, cabos_veias.veia ";
	...
	$sql .= "AND subsistema.id_area = '".$_POST["id_area"]."' ";
