...
<body  class="body">
<center>
<form name="frm_equipamentos" id="frm_equipamentos" method="post" action="<?= $PHP_SELF ?>" enctype="multipart/form-data">
                ...
                <tr>
				  ...
				  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="17%" class="label1">CÓD. EQUIPAMENTO </td>
                      <td width="1%"> </td>
			...
			<div id="tbbody" style="position:relative; width:100%; height:200px; z-index:2; overflow-y:scroll; overflow-x:hidden; border-color:#999999; border-style:solid; border-width:1px;">
			  <table width="100%" cellpadding="0" cellspacing="0" class="corpo_tabela">
				<?php
					...
					$sql .= "WHERE id_disciplina = '" .$disciplina["id_setor"] . "' "; 
					...
					{	
						...
						<tr bgcolor="<?= $cor ?>" onMouseOver="setPointer(this, 1, 'over', '<?= $cor ?>', '#BECCD9', '#FFCC99');" onMouseOut="setPointer(this, 1, 'out', '<?= $cor ?>', '#BECCD9', '#FFCC99');">
						  <td width="20%"><div align="center"><?= $disciplina["setor"] ?></div></td>
						  <td width="31%"><div align="center"><?= $equipamentos["cd_local"] ?></div></td>
						  <td width="40%"><div align="center"><?= $equipamentos["ds_equipamento"] ?></div></td>
						  <td width="4%"><div align="center"> <a href="javascript:editar('<?= $equipamentos["id_equipamentos"] ?>')"><img src="../images/buttons_action/editar.png" width="16" height="16" border="0"></a> </div></td>
