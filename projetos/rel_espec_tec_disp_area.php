...
$pdf->SetXY(25,$y);
$pdf->SetFont('Arial','B',8);
$pdf->Cell(50,4,'CONTROLE DE REVISÔES',0,1,'L',0);
$pdf->SetFont('Arial','',6);
...
$sql = "SELECT * FROM Projetos.area, Projetos.subsistema, Projetos.malhas, Projetos.processo, Projetos.componentes, Projetos.funcao, Projetos.dispositivos, Projetos.locais, Projetos.tipo, Projetos.especificacao_tecnica, ".DATABASE.".setores ";
