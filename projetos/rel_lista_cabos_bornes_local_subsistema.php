...
$sql1 = "SELECT * FROM ".DATABASE.".setores, Projetos.area, Projetos.subsistema, Projetos.locais  ";
...
while ($locais = mysqli_fetch_array($regis1))
{
	...
	$sql .= "FROM Projetos.subsistema, Projetos.cabos_tipos, Projetos.cabos ";
	...
	$sql .= "ORDER BY nr_subsistema, ds_formacao, seq_veia ";
...
$sql0 .= "AND subsistema.id_subsistema = '".$_POST["id_subsistema"]."' ";
...
while ($comp = mysqli_fetch_array($regis0))
{
	...
	$sql .= "ORDER BY nr_subsistema, cabos.id_cabo, ds_formacao, seq_veia ";
