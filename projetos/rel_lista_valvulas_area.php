...
{	
	...
	$this->Cell(127,5,'',0,0,'L',0); // CÉLULA LOGOTIPO
	$this->SetFont('Arial','B',10);
	$this->Cell(119,5,"LISTA DE VÁLVULAS",0,0,'C',0); // CÉLULA COMPONENTE
	$this->SetFont('Arial','',6);
...
$pdf->Cell(285,10,"LISTA DE VÁLVULAS E ACESSÓRIOS",0,1,'C',0);
$pdf->Ln(5);
...
$pdf->Cell(285,10,'LISTA DE VÁLVULAS - LEGENDA',0,1,'C',0);
$pdf->SetFont('Arial','B',10);
$pdf->Cell(10,5,'',0,0,'C',0); //MARGEM
$pdf->Cell(265,5,'VÁLVULAS E ACESSÓRIOS',1,0,'C',0);
$pdf->Cell(10,5,'',0,1,'C',0); //MARGEM
$pdf->SetFont('Arial','',8);

$sql = "SELECT * FROM Projetos.valvulas ";
$sql .= "ORDER BY ds_valvula ";
$reg = mysql_query($sql,$db->conexao) or die("Não foi possível a seleção dos dados" . $sql);
...
$pdf->SetFont('Arial','B',10);
$pdf->Cell(10,4,'',0,0,'C',0); //MARGEM
$pdf->Cell(265,4,'CONEXÕES',1,0,'C',0);
$pdf->Cell(10,4,'',0,1,'C',0); //MARGEM
$pdf->SetFont('Arial','',8);
...
if(mysql_num_rows($regcomp)>0)
{
	...
	$pdf->HCell(15,5,"DIÂM.",1,0,'C',0);

	$pdf->HCell(40,5,"ACION.",1,0,'C',0);

	$pdf->HCell(25,5,"CONEXÃO",1,0,'C',0);
	$pdf->HCell(15,5,"NORMA",1,0,'C',0);

	$pdf->HCell(15,5,"PRESSÃO",1,0,'C',0);
	
	$pdf->HCell(30,5,"CÓDIGO",1,0,'C',0);
	
	$pdf->HCell(15,5,"FLUÍDO",1,0,'C',0);
