...
$sql = "SELECT * FROM ".DATABASE.".setores, Projetos.subsistema, Projetos.malhas, Projetos.processo, Projetos.componentes, Projetos.funcao, Projetos.dispositivos, Projetos.tipo, Projetos.especificacao_tecnica, Projetos.locais ";
$sql .= "WHERE subsistema.id_subsistema = '" . $_POST["id_subsistema"] . "' ";
			...
			$pdf->SetFont('Arial','B',8);
				...
				*/
				if($malhas["processo"]!='D')
				{
					...
					$nrmalha = $nrmalha . $malhas["nr_malha"];
				}
				else
				{
