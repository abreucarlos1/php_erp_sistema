...
$reg_subsis = mysql_query($sql_subsis,$db->conexao) or die("N�o foi poss�vel estabelecer a conex�o com o banco de dados.");
	...
	?>
		...
		{
			combobox_destino.options[combobox_destino.length] = new Option('<?= $cont_subsis["numero_cliente"] . " - DVM - 0" . $cont_subsis["os"].$cont_subsis["sequencia"]." - ".$cont_subsis["documento"]." - ".$cont_subsis["disciplina"] ?>','<?= $cont_subsis["id_numcliente"] ?>');
		}
      ...
      <tr>
        <td>
		  <table width="100%" height="100%" border="0">
            ...
            <tr>
              <td colspan="4" align="center" class="kks_nivel1">ESCOLHA A &Aacute;REA / RELAT&Oacute;RIO </td>
              </tr>
            <tr>
              <td class="btn">&nbsp;</td>
