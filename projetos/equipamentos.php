...
if ($_POST["acao"]=="salvar")
{
	...
	$incsql .= "'" . maiusculas($_POST["id_disciplina"]) . "', ";
                ...
                <tr>
				  ...
				  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="13%" class="label1">C&Oacute;D. EQUIPAMENTO </td>
                      <td width="0%">&nbsp;</td>
                    ...
                    <tr>
                      <td><select name="id_disciplina" class="txt_box" id="id_disciplina" onChange="javascript:document.forms[0].cd_local.focus()">
						...
						{
							?>
							<option value="<?= $cont_disciplina["id_setor"] ?>" <? if($equipamentos["id_disciplina"]==$cont_disciplina["id_setor"]) { echo "selected"; } ?>><?= $cont_disciplina["setor"] ?></option>
							<?
				  ...
				  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td><select name="id_disciplina" class="txt_box" id="id_disciplina" onChange="javascript:document.forms[0].cd_local.focus()">
						...
						{
							?>
							<option value="<?= $cont_disciplina["id_setor"] ?>"<? if($_POST["id_disciplina"]==$cont_disciplina["id_setor"]){ echo 'selected';} ?>><?= $cont_disciplina["setor"] ?></option>
							<?
