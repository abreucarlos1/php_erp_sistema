...
<html>
<head>
<title>: : . RELAT&Oacute;RIOS LISTA DE CABOS BORNES LOCAIS . : :</title>
...
function enviar_area(area)
{
	...
	if((area!='') && (document.forms['areas'].emissao.checked))
	{
		...
		document.forms['areas'].relatorio.value='lista_cabos_bornes_local_area';
	...
	else
	{
		if(area!='')
		{
			...
			{
				document.forms['areas'].acao.value='';
				document.forms['areas'].relatorio.value='lista_cabos_bornes_area';
				document.forms['areas'].action='excel_lista_cabos_bornes_local_area.php';
				document.forms['areas'].submit();			
			}
			else
			{
				document.forms['areas'].relatorio.value='lista_cabos_bornes_local_area';
				document.forms['areas'].acao.value='';
				document.forms['areas'].action='rel_lista_cabos_bornes_local_area.php';
				document.forms['areas'].submit();
			}
		}
	}
...
function enviar_subsistema(area)
{
	...
	if((area!='') && (document.forms['areas'].emissao.checked))
	{
		document.forms['areas'].target='_self';
		document.forms['areas'].action='<?= $PHP_SELF ?>';
		document.forms['areas'].relatorio.value='lista_cabos_bornes_local_subsistema';
		document.forms['areas'].acao.value='salvar';
		document.forms['areas'].submit();
	...
	else
	{
		if(area!='')
		{
			if(document.forms['areas'].excel.checked)
			{
				document.forms['areas'].acao.value='';
				document.forms['areas'].relatorio.value='lista_cabos_bornes_local_subsistema';
				document.forms['areas'].action='excel_lista_componentes_local_subsistema.php';
				document.forms['areas'].submit();			
			}
			else
			{
				document.forms['areas'].acao.value='';
				document.forms['areas'].relatorio.value='lista_cabos_bornes_local_subsistema';
				document.forms['areas'].action='rel_lista_cabos_bornes_local_subsistema.php';
				document.forms['areas'].submit();
			}
		}
	}
      ...
      <tr>
        <td>
		  <table width="100%" height="100%" border="0">
            ...
            <tr>
              <td colspan="7" align="center" class="kks_nivel1"> lista de cABOS / bornes </td>
              </tr>
            <tr class="btn">
              <td class="btn">&nbsp;</td>
            ...
            <tr>
              ...
              <td class="btn"><select name="disciplina" class="txt_box"  id="disciplina" onkeypress="return keySort(this);">
                ...
                <?
							...
							$sql = "SELECT * FROM ".DATABASE.".setores WHERE setor IN('EL�TRICA','INSTRUMENTA��O','AUTOMA��O') ";
							$sql .= " ORDER BY setor ";
...
<?
	...
	{
		$envio_rel = false;
		if($_POST["relatorio"]=='lista_cabos_bornes_area')
		{
			?>	
				<script>	
		...
		if($_POST["relatorio"]=='lista_cabos_bornes_subsistema')
		{
			?>	
				<script>	
