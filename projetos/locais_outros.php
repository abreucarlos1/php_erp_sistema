                  ...
                  <td align="left"><table width="100%" border="0">
                    ...
                    <tr>
                      ...
                      <td><select name="id_equipamento" class="txt_box" id="id_equipamento">
						...
						{
							?>
                        <option value="<?= $cont_equipamentos["id_equipamento"] ?>" <? if($locais["id_equipamento"]==$cont_equipamentos["id_equipamento"]) { echo "selected"; } ?>>
                ...
                <tr>
                  ...
                  <td align="left"><table width="100%" border="0">
                    <tr>
                      ...
                      <td width="1%">&nbsp;</td>
                      <td width="37%"><span class="label1"> CLASSIFICA&Ccedil;&Atilde;O DA &Aacute;REA </span></td>
                      <td width="3%">&nbsp;</td>
                      <td width="16%">&nbsp;</td>
                      <td width="3%">&nbsp;</td>
                    </tr>
                    <tr>
                      ...
                      <td><table width="100%" border="0">
                        <tr>
                          <td width="37%" class="label1"><input name="ds_abrigado" type="radio" value="1"  <? if($locais["ds_abrigado"]==1) { echo "checked"; } ?>>
                            SIM</td>
                          <td width="63%"><input name="ds_abrigado" type="radio" value="0" <? if($locais["ds_abrigado"]==0) { echo "checked"; } ?>>
                  ...
                  <td align="left"><table width="100%" border="0">
                    ...
                    <tr>
                      ...
                      <td><select name="id_equipamento" class="txt_box" id="id_equipamento">
						...
						{
							?>
                        <option value="<?= $cont_equipamentos["id_equipamento"] ?>" <? if($_POST["id_equipamento"]==$cont_equipamentos["id_equipamento"]) { echo "selected"; } ?>>
                        <?= $cont_equipamentos["cd_local"] . " - " . $cont_equipamentos["ds_equipamento"] ?>
                        </option>
                        <?
                ...
                <tr>
                  ...
                  <td align="left"><table width="100%" border="0">
                    <tr>
                      ...
                      <td width="1%">&nbsp;</td>
                      <td width="35%"><span class="label1">CLASSIFICA&Ccedil;&Atilde;O DA &Aacute;REA</span></td>
                      <td width="19%">&nbsp;</td>
                      <td width="3%">&nbsp;</td>
                      <td width="3%">&nbsp;</td>
                    </tr>
