			 ...
			 <div id="editar" style="position:relative; width:100%; height:100%; z-index:2; border-color:#999999; border-style:solid; border-width:1px;">
			  ...
			  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  ...
                  <td align="left"><table width="100%" border="0">
                    ...
                    <tr>
                      ...
                      <td><select name="id_equipamento" class="txt_box" id="id_equipamento" onkeypress="return keySort(this);">
						...
						{
							?>
                        <option value="<?= $cont_equipamentos["id_equipamentos"] ?>" <?php if($locais["id_equipamento"]==$cont_equipamentos["id_equipamentos"]) { echo "selected"; } ?>>
                  ...
                  <td align="left"><table width="100%" border="0">
                    ...
                    <tr>
                      ...
                      <td><table width="80%" border="0">
                        <tr>
                          <td width="47%" class="label1"><input name="ds_abrigado" type="radio" value="1"  <?php if($locais["ds_abrigado"]==1) { echo "checked"; } ?>>
                            SIM</td>
                          <td width="53%"><input name="ds_abrigado" type="radio" value="0" <?php if($locais["ds_abrigado"]==0) { echo "checked"; } ?>>
                ...
                <tr>
                  ...
                  <td align="left"><table width="100%" border="0">
                    <tr>
                      <td><span class="label1">CLASSIFICAÇÃO DA ÁREA </span></td>
                      <td> </td>
                      <td> </td>
                    </tr>
                    <tr>
