...
/*
		...
		Versão 1 --> Mudan�a de estrutura / sem filtro por vari�vel
	...
	if ($regs>0)
		{
			?>
			<script>
				alert('T�pico j� cadastrado no banco de dados.');
			</script>
			<?
		}
	else
...
if ($_POST["acao"]=="salvar")
{
	...
	if ($regs>0)
	...
	else
		{
			...
			$incsql = "INSERT INTO Projetos.especificacao_padrao_topico ";
			$incsql .= "(disciplina, ds_topico) ";
			$incsql .= "VALUES ('" . $_POST["disciplina"] . "', '" . maiusculas($_POST["ds_topico"]) ."') ";
...
{
	if(confirm('Tem certeza que deseja excluir o t�pico '+ds_topico+' ?'))
	{
                ...
                <tr>
                  ...
                  <td width="99%" align="left"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="21%" class="label1">T&Oacute;PICO</td>
                      <td width="1%">&nbsp;</td>
			  ...
			  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
				  ...
				  <input name="acao" type="hidden" id="acao" value="salvar">
                    ...
                    <input name="Inserir3" type="button" class="btn" id="Inserir3" value="VARI�VEL" onClick="javascript:location.href='especificacao_padrao_variavel.php'"></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
        ...
        <td>
			...
			<table width="100%" class="cabecalho_tabela" cellpadding="0" cellspacing="0" border=0>
				<tr>
				  ...
				  <td width="74%"><a href="#" class="cabecalho_tabela" onClick="ordenar('ds_topico','<?= $ordem ?>')">T&Oacute;PICO</a></td>
					...
					while ($topico = mysqli_fetch_array($registro))
					{
						...
						<tr bgcolor="<?= $cor ?>" onMouseOver="setPointer(this, 1, 'over', '<?= $cor ?>', '#BECCD9', '#FFCC99');" onMouseOut="setPointer(this, 1, 'out', '<?= $cor ?>', '#BECCD9', '#FFCC99');">
						  <td width="18%"><div align="center">
						    <? if($topico["disciplina"]=="INS"){ echo 'EEI';}
							   else
							   { echo 'MEC/TUB';}
							 ?>
					      </div></td>
