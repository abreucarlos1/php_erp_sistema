...
function Header()
{
	...
	$this->Cell(114,5,$this->Subsistema() ,1,0,'C',0); // C�LULA AREA / SUBSISTEMA
	$this->Cell(12,5,'EMISSÃO:',0,0,'R',0); //aqui
	$this->Cell(12,5,$this->Emissao(),0,1,'R',0); //aqui
	$this->Line(172,24,195,24);
	$this->Cell(31,5,'',0,0,'L',0); // C�LULA LOGOTIPO
	$this->Cell(114,5,$this->Area(),1,0,'C',0); // C�LULA COMPONENTE
	...
	*/
	...
	$this->Cell(45,5.5,'',0,0,'L',0); // C�LULA LOGOTIPO
	$this->SetFont('Arial','B',10);
	$this->Cell(85,5.5,"LISTA DE MALHAS",1,0,'C',0); // C�LULA COMPONENTE
...
$pdf->subsistema = "LISTA DE MALHAS"; // DIVIS�O
$pdf->area = $reg["nr_area"]." ".$reg["ds_area"]; // �REA
