...
<html>
<head>
<title>: : . RELAT&Oacute;RIOS LISTA DE CABOS BORNES . : :</title>
	...
	else
	{
		if(area!='')
		{
			if(document.forms['areas'].excel.checked)
			{
				//document.forms['areas'].acao.value='';
				//document.forms['areas'].relatorio.value='lista_cabos_bornes_area';
				//document.forms['areas'].action='excel_lista_componentes_area.php';
				//document.forms['areas'].submit();			
			}
			else
			{
				document.forms['areas'].relatorio.value='lista_cabos_bornes_area';
				document.forms['areas'].acao.value='';
				document.forms['areas'].action='rel_lista_cabos_bornes_area.php';
				document.forms['areas'].submit();
			}
		}
	}
...
function enviar_subsistema(area)
{
	...
	if((area!='') && (document.forms['areas'].emissao.checked))
	{
		document.forms['areas'].target='_self';
		document.forms['areas'].action='<?= $PHP_SELF ?>';
		document.forms['areas'].relatorio.value='lista_cabos_bornes_subsistema';
		document.forms['areas'].acao.value='salvar';
		document.forms['areas'].submit();
	...
	else
	{
		if(area!='')
		{
			...
			else
			{
				document.forms['areas'].acao.value='';
				document.forms['areas'].relatorio.value='lista_cabos_bornes_subsistema';
				document.forms['areas'].action='rel_lista_cabos_bornes_subsistema.php';
				document.forms['areas'].submit();
			}
		}
	}
