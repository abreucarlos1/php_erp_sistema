...
function enviar_area(area)
{
	...
	if((area!='') && (document.forms['areas'].emissao.checked))
	{
		...
		document.forms['areas'].relatorio.value='especificacao_hardware_area';
	...
	else
	{
		...
		{
			document.forms['areas'].acao.value='';
			document.forms['areas'].action='rel_especificacao_hardware_area.php';
			document.forms['areas'].submit();
		}
	}
      ...
      <tr>
        <td>
		  <table width="100%" height="100%" border="0">
            ...
            <tr>
              <td colspan="7" align="center" class="kks_nivel1"> ESPECIFICA&Ccedil;&Atilde;O de hardware </td>
              </tr>
            <tr class="btn">
              <td class="btn">&nbsp;</td>
