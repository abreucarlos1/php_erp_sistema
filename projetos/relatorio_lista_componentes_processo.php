...
function enviar_area(area)
{
	...
	if((area!='') && (document.forms['areas'].emissao.checked))
	{
		...
		document.forms['areas'].relatorio.value='lista_componentes_area';
	...
	else
	{
		if(area!='')
		{
			if(document.forms['areas'].excel.checked)
			{
				document.forms['areas'].acao.value='';
				document.forms['areas'].relatorio.value='lista_componentes_area';
				document.forms['areas'].action='excel_lista_componentes_processo.php';
				document.forms['areas'].submit();			
			}
			else
			{
				document.forms['areas'].acao.value='';
				document.forms['areas'].action='rel_lista_componentes_area_processo.php';
				document.forms['areas'].submit();
			}
		}
	}
...
function enviar_subsistema(area)
{
	...
	{
		document.forms['areas'].target='_self';
		document.forms['areas'].action='';
		document.forms['areas'].relatorio.value='lista_componentes_subsistema';
		document.forms['areas'].acao.value='salvar';
		document.forms['areas'].submit();
	...
	else
	{
		if(area!='')
		{
			...
			else
			{
				document.forms['areas'].acao.value='';
				document.forms['areas'].relatorio.value='lista_componentes_subsistema';
				document.forms['areas'].action='rel_lista_componentes_subsistema.php';
				document.forms['areas'].submit();
			}
		}
	}
      ...
      <tr>
        <td>
		  <table width="100%" height="100%" border="0">
            ...
            <tr>
              <td colspan="7" align="center" class="kks_nivel1"> lista de componentes / processo </td>
              </tr>
            <tr class="btn">
              <td class="btn">&nbsp;</td>
...
<?
	...
	{
		$envio_rel = false;
		if($_POST["relatorio"]=='lista_componentes_area')
		{
			?>	
				<script>	
		...
		if($_POST["relatorio"]=='lista_componentes_subsistema')
		{
			?>	
				<script>	
