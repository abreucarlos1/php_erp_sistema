...
{
	$objPHPExcel = PHPExcel_IOFactory::load("lp/modelo_LP_modelo.xls");
}
...
foreach($db->array_select as $regs)
{
	...
	$fator_p = ceil(strlen($regs["identificacao_problema_ap"])/50); //pendência
	...
	{		
		switch ($regs["pendencia_interna"])
		{
			...
			default: $pend_ext = "PENDÊNCIA EMPRESA";
		}
