        ...
        <tr>
            ...
            <table border="0" width="100%">
		  	...
		  	<table border="0" width="100%">
				<tr>
					<td width="10%">
                    		<label for="data" class="labels"><smarty>$campo[3]</smarty>*</label><br />
					...
					<td width="90%"><label for="os" class="labels"><smarty>$campo[4]</smarty>*</label><br />
		  ...
		  <table border="0" width="100%">
		    <tr>
		      <td width="23%"><label for="disciplina" class="labels"><smarty>$campo[5]</smarty>*</label><br />
