...
<div align="center" style="width:100%;">
	...
	<div style="width:600px;border:1px; border-style:solid; border-color: #1B4470;">
	
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">

            <tr>
				<td align="center" class="cor_1"><div style="width:302px; height:70px; margin-top:3px; margin-bottom:3px;"></div></td>
			</tr>
