...
//{
	...
	//$sql .= "AND funcionarios.id_local NOT IN ('3','13','34') ";
	//$sql .= "AND usuarios.CodUsuario = permissoes.id_usuario ";
	//$sql .= "AND funcionarios.id_funcionario = 556 ";
	...
	while($reg = mysqli_fetch_assoc($cont))
	{
		...
		$sql .= "WHERE permissoes.id_usuario = '".$reg["CodUsuario"]."' "; //carlos
