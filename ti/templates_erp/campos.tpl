        ...
        <tr>
        	<td width="116" valign="top" class="espacamento">
        		<table width="100%" border="0">
        			<tr>
        				<td valign="middle">
        					<input name="btninserir" type="button" class="class_botao" id="btninserir" onclick="xajax_insere(xajax.getFormValues('frm_campos'));" value="Inserir" /></td>
					</tr>
        			<tr>
		  ...
		  <table border="0" width="100%">
				<tr>
					<td width="9%"><label for="tela" class="labels">Tela</label><br />
					...
					<td width="25%"><label for="texto" class="labels">Descrição</label><br />
						<input name="texto" type="text" class="caixa" id="texto" size="30" placeholder="Texto" /></td>
					<td width="9%"><label for="idioma" class="labels">Idioma</label><br />
					...
					<td width="57%"><label for="ordem" class="labels">Ordem</label><br />
