        ...
        <tr>
        	<td width="116" valign="top" class="espacamento">
        		<table width="100%" border="0">
        			<tr>
        				<td valign="middle">
        					<input name="btninserir" type="button" class="class_botao" id="btninserir" onclick="xajax_insere(xajax.getFormValues('frm_botoes'));" value="Inserir" /></td>
					</tr>
        			<tr>
		  ...
		  <table border="0" width="100%">
				<tr>
					<td width="25%"><label for="texto" class="labels">Texto</label><br />
					...
					<td width="66%"><label for="ordem" class="labels">Ordem</label><br />
