...
/*
		...
		../coordenacao/controle_saldo_tarefas_protheus.php
...
if(!verifica_sub_modulo(216) && !verifica_sub_modulo(297) && !verifica_sub_modulo(261))
{
	nao_permitido();
}
...
$smarty->assign("campo",$conf->campos('controle_saldo_tarefas_protheus'));

$smarty->assign("botao",$conf->botoes());

$smarty->assign("classe",CSS_FILE);

$smarty->display('controle_saldo_tarefas_protheus.tpl');
?>