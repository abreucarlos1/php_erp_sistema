<?php
/*
		Formulário de Controle OS status
		
		Criado por Carlos Abreu 
		
		local/Nome do arquivo:		
		../coordenacao/controle_acumulado_os_status_protheus.php

		Versão 0 --> VERSÃO INICIAL - 02/03/2006
		Versão 1 --> Atualização Lay-out | Smarty : 21/07/2008
		Versão 2 --> Atualização Layout: 27/11/2014
...
$smarty->assign("nome_formulario","ACOMPANHAMENTO DE OS - TAREFAS - PROTHEUS");

$smarty->assign("revisao_documento","V4");

$smarty->assign("campo",$conf->campos('acomp_os_status_protheus'));
$smarty->assign("botao",$conf->botoes());

$smarty->assign("classe",CSS_FILE);

$smarty->display('controle_acumulado_os_status_protheus.tpl');
?>