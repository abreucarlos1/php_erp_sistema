...
<form name="frm_rel" id="frm_rel" action="relatorios/rel_saldo_tarefas_protheus.php" method="POST" style="margin:0px; padding:0px;">
	<table width="100%" border="0">        
        ...
        <tr>
		  ...
		  <table width="100%" border="0">
				...
				<tr>
				  <td><span class="labels">DISCIPLINA</span></td>
		    </tr>
				<tr>
				  <td>
