...
<form name="frm_rel" id="frm_rel" action="../coordenacao/relatorios/rel_acumulado_os_atividade_protheus.php" method="POST" style="margin:0px; padding:0px;" target="_blank">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">        
        ...
        <tr>
		  ...
		  <table width="100%" border="0">
				<tr>
					<td width="100%" align="left"><label class="labels">COORDENADOR</label><br />
