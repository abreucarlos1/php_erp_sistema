...
/*
	  ...
	  ../coordenacao/controle_saldo_disciplinas_protheus.php
...
if(!verifica_sub_modulo(279) && !verifica_sub_modulo(298) && !verifica_sub_modulo(261))
{
	nao_permitido();
}
...
if ($db->erro != '')
{
	exit("Erro ao tentar selecionar os dados.");
}
...
$smarty->assign("campo",$conf->campos('controle_saldo_disciplinas_protheus'));

$smarty->assign("botao",$conf->botoes());

$smarty->assign("classe",CSS_FILE);

$smarty->display('controle_saldo_disciplinas_protheus.tpl');
?>