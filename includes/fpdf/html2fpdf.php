...
require(INCLUDE_DIR."fpdf".DIRECTORY_SEPARATOR."fpdf.php");
require(INCLUDE_DIR."fpdf".DIRECTORY_SEPARATOR."htmltoolkit.php");
...
//! @desc Pass meta tag info to PDF file properties
  ...
  //".DATABASE." do Aplicativo usado (no caso um script):
			  ...
			  case 'FONT-SIZE': //Does not support: smaller, larger
                 ...
                 case 'X-SMALL': $this->SetFontSize( (0.77) * 11);
  			         ...
  			         case 'XX-LARGE': $this->SetFontSize( 2*11);
			  			...
			  			$this->SetFontSize(11); //SETANDO A FONTE DE FORMA FIXA - OT�VIO 06/08/2008
            }
			   	  break;
...
//! @desc Disable some tags using ',' as separator. Enable all tags calling this function without parameters.
  if ($str == '') //enable all tags
  {
    ...
    $this->enabledtags = "<tt><kbd><samp><option><outline><span><newpage><page_break><s><strike><del><bdo><big><small><address><ins><cite><font><center><sup><sub><input><select><option><textarea><title><form><ol><ul><li><h1><h2><h3><h4><h5><h6><pre><b><u><i><img><p><br><strong><em><code><th><tr><blockquote><hr><td><tr><table><div>";
  }
  else
  {
    $str = explode(",",$str);
