...
$smarty->assign("body_onload","xajax_monta_menu(25);"); //MÓDULO RECURSOS HUMANOS

$conf = new configs();

$smarty->assign("revisao_documento","V3");

$smarty->assign("campo",$conf->campos('menumateriais'));
