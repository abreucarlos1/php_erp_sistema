...
/*
	...
	../manuais_sistemas/menurhmanuais.php
...
$smarty->assign("body_onload","xajax_monta_menu(568);");

$conf = new configs();

$smarty->assign("revisao_documento","V1");

$smarty->assign("campo",$conf->campos('menu_manuais_rh'));
