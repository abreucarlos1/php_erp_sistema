...
/*
		...
		../contratos_controle/controle_orcamento_protheus.php
		
		Versão 0 --> VERSÃO INICIAL - 25/07/2013
		Versão 1 --> Alteração de layout: 08/01/2015
		Versão 2 --> alteração layout - Carlos Abreu - 23/03/2017
...
function preencheos($id_coordenador)
{
	...
	{
		$resposta->addAlert("Não foram encontradas OS's para este coordenador!");
	}
	*/
...
$smarty->assign("nome_formulario","PLANILHA ORÇAMENTO ELABORAÇÃO - PROTHEUS");

$smarty->assign('revisao_documento', 'V3');

$smarty->assign('campo', $conf->campos('planilha_orcamento_elaboracao_protheus'));

$smarty->assign("classe",CSS_FILE);

$smarty->display('controle_orcamento_protheus.tpl');
?>