...
$sql = 
"SELECT
    bms_pedido.os, ordem_servico.os, valor_pedido, data_pedido data, numero_item, descricao, quantidade, valor, id_bms_pedido, condicao_pgto, id_empresa_erp, empresa, formato
  FROM
    ...
    JOIN (SELECT id_os, id_empresa_erp, os FROM ".DATABASE.".ordem_servico WHERE ordem_servico.reg_del = 0) os ON os.id_os = bms_pedido.os 
...
GROUP BY
  bms_pedido.os, numero_item, id_bms_pedido
ORDER BY
	OS.id_empresa_erp, bms_pedido.os desc";
