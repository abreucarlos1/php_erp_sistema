<?php
/*
	Formulário de Plano de Custos
	
	Criado por Carlos Abreu  
	
	local/Nome do arquivo: 
	../contratos_controle/planocustos.php
	
	Versão 0 --> VERSÃO INICIAL : 28/10/2013
		...
		// Loop through the directory			 
			...
			// Check that this file is not to be ignored 
				...
				{ 
					...
					$pth = DOCUMENTOS_CONTROLE."Plano de Custo/";					
...
function treegrid(xml)
{
	...
	function open_doc(id)
	{
		...
		if(ext[1]!=null)		
		{
			document.getElementById("documento").value = <?php echo DOCUMENTOS_CONTROLE ?>"plano_custo/"+id;
