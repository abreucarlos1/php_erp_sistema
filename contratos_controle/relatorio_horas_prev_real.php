<?php
/*
		Formulário de Relatorio Horas Prev. x Real	
		
		Criado por Carlos Abreu  
		
		local/Nome do arquivo:
		../contratos_controle/relatorio_horas_prev_real.php
	
		Versão 0 --> VERSÃO INICIAL : 17/09/2013 - Carlos Abreu
		Versão 1 --> Inclusão de filtro por fase - 15/01/2015 - Carlos Abreu
		Versão 2 --> atualização layout - Carlos Abreu -  23/03/2017
*/	
...
$smarty->assign("campo",$conf->campos('relatorio_horas_prev_real'));
...
$smarty->display('relatorio_horas_prev_real.tpl');
