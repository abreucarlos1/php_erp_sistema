...
<form name="frm" id="frm" action="relatorios/rel_idc_idp_excel.php" method="POST">
	<table width="100%" border="0">               
        <tr>
		  ...
		  <table border="0" width="100%">
				<tr>
					<td width="18%"><label for="escolhafase" class="labels">Fase</label><br />
 			  ...
 			  <tr>
				<td width="13%"><label for="escolhaos" class="labels">Projeto</label><br />
